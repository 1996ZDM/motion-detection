...
if __name__ == '__main__':
    ...
    cam = cv2.VideoCapture('D:/code/vehicle-speed-check/data/mobilecars.avi')  # 读取视频
    ...
    while True:
        ...
        if ret == True:  # 判断视频是否结束
            ...
            flow = cv2.calcOpticalFlowFarneback(prevgray, gray, None,0.5, 3, 15, 3, 5, 1.2, 0)  # Farnback光流法
